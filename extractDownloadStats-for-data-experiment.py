...
def extractDownloadStatsForYear(year):
    ...
    print '==================================================================='
    print '==================================================================='
    print 'START EXTRACTING DATA-EXPERIMENT PACKAGE DOWNLOAD STATS '
    ...
    stats_utils.extract_all_stats_for_year(c, biocrepo, year)
    c.close()
    conn.close()
    os.chdir(wd0)
    print ''
    print '==================================================================='
    print '==================================================================='
    print 'DONE EXTRACTING DATA-EXPERIMENT PACKAGE DOWNLOAD STATS '
    print 'FOR YEAR %s' % year
    print '==================================================================='
    print '==================================================================='
    print ''
