...
./makeDownloadStatsHTML-for-data-experiment.py
if [ $? -ne 0 ]; then
...
rsync --delete -ave 'ssh -o StrictHostKeyChecking=no' $HTML_STATS_HOME/ webadmin@master.bioconductor.org:/extra/www/bioc/packages/oldstats/
